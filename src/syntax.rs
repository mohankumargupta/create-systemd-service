use syntect::{
    easy::HighlightLines,
    highlighting::{FontStyle, HighlightIterator, HighlightState, Highlighter, Style, ThemeSet},
    parsing::{ParseState, SyntaxSet, SyntaxSetBuilder},
...
impl<'a> SyntaxText<'a> {
    pub fn new(text: &'a String) -> Self {
        ...
        builder.add_from_folder("src/resources/INI", false).unwrap();
